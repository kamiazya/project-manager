...
describe('service-factory', () => {
  ...
  describe('error handling', () => {
    ...
    it('should handle factory createUseCaseFactory throwing error', () => {
      ...
      vi.mocked(UseCaseFactoryProvider.getInstance).mockReturnValue(mockProviderInstance)
    ...
    it('should handle container binding throwing error', () => {
      ...
      vi.mocked(Container).mockReturnValue(errorContainer)
