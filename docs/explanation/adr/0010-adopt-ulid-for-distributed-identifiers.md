...
**We adopt ULID (Universally Unique Lexicographically Sortable Identifier) as the standard identifier format for all domain entities (Ticket, Epic, Project) in Project Manager.**
